...
The package declares `0.6.0`, but no GitHub release is currently published. The first public protocol release must match the package version and include the reproduction artifact and validation evidence.
